      ...
      <div className="max-w-[1400px] mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex items-center gap-1.5 text-gray-500 hover:text-gray-400 transition-colors cursor-not-allowed"
          >
            ...
            <span className="text-xs text-gray-500">건전한 피드백 제공</span>
          </a>
