  ...
  ROSTER: [
    {
      ...
      popover: {
        ...
        description: '"캐릭터명-서버명" 형식으로 한 줄에 하나씩 입력하면 Blizzard API로 정보를 자동으로 불러오고 역할이 자동 배치됩니다.',
        side: 'bottom',
        align: 'start',
      },
    },
    ...
    },
    {
      ...
      popover: {
        ...
        description: '완성된 공대 구성을 클립보드에 복사하거나, Discord 웹훅을 연동해 채널에 바로 전송할 수 있습니다.',
        side: 'bottom',
        align: 'end',
      },
    },
  ...
  RAID_MARKET: [
    {
      ...
      popover: {
        title: '장부 입력',
        description: '애드온에서 내보낸 거래 장부를 붙여넣으세요. 형식: 아이템ID;낙찰자;골드. 아이템 아이콘과 이름이 자동으로 불러와집니다.',
        side: 'bottom',
        align: 'start',
      },
    },
    {
      ...
      popover: {
        title: '장부 불러오기',
        description: '버튼을 누르면 입력한 장부를 파싱해 거래 내역과 분배 계산기가 표시됩니다.',
        side: 'bottom',
        align: 'start',
      },
    },
    {
      ...
      popover: {
        title: '분배 계산기',
        description: '총 모금액에서 공대비를 제하고 인원수로 나눠 1인당 분배금을 자동 계산합니다.',
        side: 'left',
        align: 'start',
      },
    },
    {
      ...
      popover: {
        title: '회차 저장',
        description: '거래 내역을 회차별로 저장하면 누적 기록에서 과거 내역과 수익 추이를 확인할 수 있습니다.',
        side: 'top',
        align: 'start',
      },
    },
